		...
		<div className='question'>
			...
			<div className='qa'>
				...
				<table>
					...
					<tr>
						<td>1. You can read Props data.</td>
						<td>1. You can read and write state data.</td>
					</tr>
					<tr>
						<td>2. Props can not modified.</td>
						<td>2. State can be modified.</td>
					</tr>
					<tr>
						<td>3. Child component can access the props.</td>
						<td>3. Child component can not access the state.</td>
					</tr>
					<tr>
						<td>4. Props help to pass data one component to another component.</td>
						<td>4. State Keep data about component.</td>
					</tr>
					<tr>
						<td>5. By props you can reuse component.</td>
						<td>5. By state you can not reuse component.</td>
					</tr>
				</table>
			</div>
			<div className='qa'>
